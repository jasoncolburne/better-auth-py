"""Device management message types for better-auth.

This module defines message types for device operations including linking,
unlinking, rotation, and the signable link container.
"""
...
class RotateDeviceRequest(ClientRequest[Dict[str, Any]]):
    ...
    @staticmethod
    def parse(message: str) -> RotateDeviceRequest:
        ...
        Returns:
            A new RotateDeviceRequest instance with the parsed data
            and signature.
...
class RotateDeviceResponse(ServerResponse[Dict[str, Any]]):
    ...
    @staticmethod
    def parse(message: str) -> RotateDeviceResponse:
        ...
        Returns:
            A new RotateDeviceResponse instance with the parsed data
            and signature.
